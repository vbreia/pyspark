...
> `info`
> [Learn more about the repository](/faculdade/README.MD)

- [lesson_1](./Faculdade/01.aula_1.ipynb) - notebook with the first PySpark lesson
